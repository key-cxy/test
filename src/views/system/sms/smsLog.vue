<template>
  <div class="app-container">
    ...
    <el-row>
      <el-col :span="3">
        <el-card>
          <div style="font-size: 20px">发送数量</div>
          <div style="text-align: center;font-size: 24px;font-weight: bolder">{{countInfo.totalNum}}</div>
          <div style="text-align: center;font-size: 18px">成功率：<span style="color: #008f4a">{{countInfo.successRate}}</span></div>
        </el-card>
      </el-col>
      <el-col :span="21">
...
<script>
import { getSmsLogPage, exportSmsLogExcel,getSmsLogCount } from "@/api/system/sms/smsLog";
