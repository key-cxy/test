  ...
  <div style="margin-top: 20px">
    <Row class="container">
      <Col :span="4" style="height: 100%; overflow-y: scroll">
        <div style="width: 90%; margin-left: 4%; background-color: #f8f8f9">
          <el-input
        ...
        <div>
          ...
          >
            <Form
              ...
              :label-width="130"
            >
              <FormItem label="大类名称：" prop="name">
                <Input v-model="modalForm.name" placeholder="大类名称" />
              </FormItem>
<!--              <FormItem label="当前版本：" prop="version">-->
<!--                <Input v-model="modalForm.version" placeholder="当前版本" />-->
<!--              </FormItem>-->
              <FormItem label="绑定部门：" prop="departmentId">
                <el-cascader
                  style="width: 588px"
...
import getNodeById from "@/libs/tree.js";
...
export default {
  ...
  methods: {
    ...
    handleSearch() {
      ...
      param.append("pageNo", this.currentPageNum);
    ...
    async handleEditRow(row) {
      ...
      if (this.modalForm.organizationIds) {
        const arr = [];
        this.modalForm.organizationIds.forEach((item) => {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            let item = "";
            params.row.organizationIds.forEach((i) => {
              if (i.deptName) {
                item = item + i.deptName + " ";
              }
            });
            return h("div", [
              h(
