...
<!--        </div>-->
      ...
      <div class="rightItem">
        ...
        <div v-if="phStatus == 1">
          ...
          <div class="card" v-for="item in historyList">
            <div class="item" style="color: rgb(24, 144, 255)">
