  ...
  <div class="table-box">
    ...
    >
      ...
      <span slot="action" slot-scope="text, record">
        <el-button type="primary" @click="handleShowDetail(record, true)"
          >处理</el-button
        >
        <el-button type="success" @click="handleViewRow(record)"
          >流程图</el-button
        >
        <!-- <a-popconfirm
          title="确定删除？"
...
export default {
  ...
  computed: {
    ...mapState({
      list: (state) => state.questionHandle.list,
      pageNum: (state) => state.questionHandle.pageNum,
      pageSize: (state) => state.questionHandle.pageSize,
      total: (state) => state.questionHandle.total
      // userType: (state) => state.questionHandle.userType
    }),
    rowSelection() {
  ...
  methods: {
    ...mapActions({
      handleSearchInfo: 'questionHandle/handleSearchInfo',
      handlePageData: 'questionHandle/handlePageData',
      handlePagination: 'questionHandle/handlePagination',
      handleChangeUserType: 'questionHandle/handleChangeUserType'
    }),
    handleSearch() {
    ...
    handleShowDetail(record, isShowHandle) {
      this.$emit('showDetail', record, isShowHandle)
    },
    handleViewRow(row) {
      const param = {
