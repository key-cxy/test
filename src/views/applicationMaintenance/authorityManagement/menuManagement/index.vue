    ...
    <el-row :gutter="24">
      ...
      <el-col :span="20">
        ...
        >
          ...
          <el-form-item label="菜单名称" prop="name">
            <!-- <el-input
              ...
              @keyup.enter.native="handleQuery"
            /> -->
            <el-input v-model="queryParams.name" placeholder="菜单名称" clearable>
              <!--          <el-option-->
        ...
        >
          ...
          <el-table-column prop="sort" label="显示排序" width="100">
          </el-table-column>
...
// import { menuTree } from '@/views/applicationMaintenance/authorityManagement/menuManagement/api'
...
export default {
  ...
  methods: {
    ...
    menuSelect() {
      ...
      menuSelect({}).then((response) => {
        ...
        response.data.forEach((item) => {
          ...
          _self.queryParams.name = _self.dataOptions.value
        })
      })
    },
    // 选择图标
    ...
    getList() {
      ...
      // }
      let newsystemId = {systemId:this.systemId }
      console.log(this.systemId)
      getTreeIdApi(newsystemId).then((response) => {
        this.menuList = handleTree(response.data, 'id', 'parentId')
    ...
    handleUpdate(row) {
      ...
      this.reset()
      this.getTreeselect()
      menuInformation(row.id).then((response) => {
      ...
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          if (this.form.id !== undefined) {
            ...
            let JSForm = JSON.stringify(this.form)
            console.log('JSForm',JSForm)
            console.log('JSForm',this.form)

            addMenuApi(JSForm).then((response) => {
    ...
    handleDelete(row) {
      this.$modal
        ...
        .then(function() {
          return deleteMenuApi({ id:row.id })
        })
        .then(() => {
          this.getList()
