...
<!--          </el-form-item>-->
        ...
        <el-table v-loading="loading" :data="roleList">
          ...
          <el-table-column label="上级角色" prop="parentName" :show-overflow-tooltip="true" width="150" />
          <el-table-column label="创建人" prop="creator" width="100" />
          <el-table-column label="角色人员" prop="roleUserCount" width="100" />
          <el-table-column label="角色描述" prop="remark" />
          <el-table-column label="绑定部门" prop="deptName" :show-overflow-tooltip="true" width="150" />
