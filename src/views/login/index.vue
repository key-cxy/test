<template>
    <div class="login-page">
      <div class="form-cont">
        <el-tabs class="form" v-model="loginForm.loginType" style=" float:none;" @tab-click="loginHandleClick">
          ...
          <el-form ref="loginForm" :model="loginForm" :rules="LoginRules" class="login-form">
            ...
            <div v-if="loginForm.loginType === 'sms'">
              ...
              <el-form-item prop="mobileCode">
                <el-input v-model="loginForm.mobileCode" type="text" auto-complete="off" placeholder="短信验证码" @keyup.enter.native="handleLogin">
                  <template slot="icon">
                    <svg-icon slot="prefix" icon-class="password" class="el-input__icon input-icon" />
                  </template>
    ...
    methods: {
      ...
      getCookie() {
        ...
        this.loginForm = {
          ...
          mobileCode:
            mobileCode === undefined ? this.loginForm.mobileCode : mobileCode,
          loginType:
            loginType === undefined ? this.loginForm.loginType : loginType,
        };
      },
      handleLogin() {
