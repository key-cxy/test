<template>
  <div>
          ...
          <div class="search" style="flex-direction: column">
            ...
            <div class="searchRow">
              <div class="searchCol">
                <span>立案条件：</span>
                <div>
                  <a-input disabled v-model="filingCondition"></a-input>
                </div>
              </div>
            </div>
            <div class="searchRow">
              <div class="searchCol">
                ...
                <div>
                  ...
                  <!--                    :props="assessmentUnitOptionProps"-->
                  <!--                    v-model="assessmentUnit"-->
                  <!--                    disabled-->
                  <!--                    clearable-->
                  <!--                    placeholder="请选择考核单位"-->
                  <!--                    @visible-change="assmentUnitVisaleChange($event)"-->
                  <!--                  ></el-cascader>-->
                </div>
              </div>
              <div class="searchCol">
    ...
    <div class="footer" v-if="!caseStatus">
...
<script>
  ...
  import { handleErrorApplyView,handlePost } from "@/api/event/aduit";
  ...
  export default {
    ...
    methods: {
      ...
      handleSave(button) {
        ...
        // }
        // 暂时放开
        // if (this.areaVal.length == 3 && this.disposer.length == 0) {
        //   this.checkInfo("案件已流传到社区，处置人员必选");
        //   return;
        // }
    ...
    async created() {
      ...
      await handleErrorApplyView({ errorApplyId: this.$route.query.handleId }).then((res) => {
        if (res.code == 200) {
