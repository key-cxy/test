  ...
  <div>
    ...
    >
      ...
      <FormItem label>
        ...
        <Button type="primary" style="margin-left: 10px" icon="md-search"
          >交 班</Button
        >
      </FormItem>
    </Form>
...
export default {
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              ...
              dateFmt(
                "YYYY-mm-dd HH:MM:SS",
                new Date(params.row.eventTaskInfo.startTime)
              )
            );
          },
        },
  ...
  mounted() {
    ...
    //   this.handleSearch();
    // }
    // this.dataTotal = this.dataTotalTemp
  ...
  methods: {
    ...
    handleSearch() {
      ...
      const params = {
        ...
        problemSourceId: this.id === 0 ? null : this.id,
    ...
    handleViewRow(row) {
      const param = {
        caseNo: row.eventTaskInfo.caseNo,
      };

      this.caseNo = row.eventTaskInfo.caseNo;
      this.eventDetailVisible = !this.eventDetailVisible;
